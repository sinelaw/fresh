...
One workspace per git worktree, each with its own tabs, terminals and coding agent. Arrow keys switch between them, and the ones you are not looking at keep running.
