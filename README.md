...
- **Setup:** Optional CPU throttling requires cgroup delegation (1-minute setup)

See [docs/PROCESS_LIMITS.md](docs/PROCESS_LIMITS.md) for detailed documentation, setup instructions, and configuration options.
...
- [TODO.md](docs/TODO.md) - Roadmap, completed features, and planned work
