...
* **Indent rainbow** - indentation guides can be colored by nesting depth with `editor.rainbow_indentation`; themes control a separate six-color `indent_rainbow_1` through `indent_rainbow_6` palette (#2632).
