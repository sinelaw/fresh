...
pub fn highlight_color(category: HighlightCategory, theme: &crate::theme::Theme) -> Color {
    match category {
...
pub fn highlight_bg(category: HighlightCategory, theme: &crate::theme::Theme) -> Option<Color> {
    match category {
