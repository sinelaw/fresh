...
pub struct PartialEditorConfig {
    ...
    pub hide_current_line_on_selection: Option<bool>,
    ...
    pub breadcrumb_all_symbols: Option<bool>,
...
impl Merge for PartialEditorConfig {
    fn merge_from(&mut self, other: &Self) {
        ...
        self.breadcrumb_all_symbols
            .merge_from(&other.breadcrumb_all_symbols);
...
pub struct PartialTerminalConfig {
    ...
    pub mouse_drag_selects: Option<bool>,
    pub mouse_forwarding: Option<crate::config::TerminalMouseForwarding>,
}
...
impl From<&crate::config::EditorConfig> for PartialEditorConfig {
    fn from(cfg: &crate::config::EditorConfig) -> Self {
        Self {
            ...
            hide_current_line_on_selection: Some(cfg.hide_current_line_on_selection),
            ...
            breadcrumb_all_symbols: Some(cfg.breadcrumb_all_symbols),
...
impl PartialEditorConfig {
    ...
    pub fn resolve(self, defaults: &crate::config::EditorConfig) -> crate::config::EditorConfig {
        crate::config::EditorConfig {
            ...
            hide_current_line_on_selection: self
                .hide_current_line_on_selection
                .unwrap_or(defaults.hide_current_line_on_selection),
            ...
            breadcrumb_all_symbols: self
                .breadcrumb_all_symbols
                .unwrap_or(defaults.breadcrumb_all_symbols),
...
impl From<&TerminalConfig> for PartialTerminalConfig {
    fn from(cfg: &TerminalConfig) -> Self {
        Self {
            ...
            mouse_drag_selects: Some(cfg.mouse_drag_selects),
            mouse_forwarding: Some(cfg.mouse_forwarding),
        }
    }
}
