...
pub enum Action {
    ...
    Revert,
    ToggleAutoRevert,
    /// Toggle between insert and overwrite (type-over) editing mode
    ToggleOverwriteMode,
    FormatBuffer,
...
impl Action {
    ...
    define_action_str_mapping! {
        ...
        simple {
            ...
            "toggle_overwrite_mode" => ToggleOverwriteMode,
...
impl KeybindingResolver {
    ...
    pub fn format_action(action: &Action) -> String {
        match action {
            ...
            Action::ToggleOverwriteMode => t!("action.toggle_overwrite_mode"),
