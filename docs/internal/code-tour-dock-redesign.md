...
![Code tour states](/blog/productivity/code-tour/showcase.gif)

Regenerated by the showcase test, the same way as every other feature demo:

```sh
cargo nextest run -p fresh-editor --test all_tests code_tour_showcase -- --ignored
