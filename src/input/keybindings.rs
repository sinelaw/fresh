...
impl Action {
    ...
    pub fn from_str(s: &str, args: &HashMap<String, serde_json::Value>) -> Option<Action> {
        match s {
            ...
            "view_warning_log" => Some(Action::ViewWarningLog),
...
impl KeybindingResolver {
    ...
    fn format_action(action: &Action) -> String {
        match action {
            ...
            Action::ShowWarnings => "Show warnings".to_string(),
            Action::ShowLspStatus => "Show LSP status".to_string(),
            Action::ViewWarningLog => "View warning log".to_string(),
            Action::ClearWarnings => "Clear warnings".to_string(),
