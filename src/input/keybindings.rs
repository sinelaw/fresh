...
impl Action {
    ...
    pub fn from_str(s: &str, args: &HashMap<String, serde_json::Value>) -> Option<Action> {
        match s {
            ...
            "show_warnings" => Some(Action::ShowWarnings),
            "show_lsp_status" => Some(Action::ShowLspStatus),
            "clear_warnings" => Some(Action::ClearWarnings),
...
impl KeybindingResolver {
    ...
    fn format_action(action: &Action) -> String {
        match action {
            Action::InsertChar(c) => t!("action.insert_char", char = c).to_string(),
            Action::InsertNewline => t!("action.insert_newline").to_string(),
            Action::InsertTab => t!("action.insert_tab").to_string(),
            Action::MoveLeft => t!("action.move_left").to_string(),
            Action::MoveRight => t!("action.move_right").to_string(),
            Action::MoveUp => t!("action.move_up").to_string(),
            Action::MoveDown => t!("action.move_down").to_string(),
            Action::MoveWordLeft => t!("action.move_word_left").to_string(),
            Action::MoveWordRight => t!("action.move_word_right").to_string(),
            Action::MoveLineStart => t!("action.move_line_start").to_string(),
            Action::MoveLineEnd => t!("action.move_line_end").to_string(),
            Action::MovePageUp => t!("action.move_page_up").to_string(),
            Action::MovePageDown => t!("action.move_page_down").to_string(),
            Action::MoveDocumentStart => t!("action.move_document_start").to_string(),
            Action::MoveDocumentEnd => t!("action.move_document_end").to_string(),
            Action::SelectLeft => t!("action.select_left").to_string(),
            Action::SelectRight => t!("action.select_right").to_string(),
            Action::SelectUp => t!("action.select_up").to_string(),
            Action::SelectDown => t!("action.select_down").to_string(),
            Action::SelectWordLeft => t!("action.select_word_left").to_string(),
            Action::SelectWordRight => t!("action.select_word_right").to_string(),
            Action::SelectLineStart => t!("action.select_line_start").to_string(),
            Action::SelectLineEnd => t!("action.select_line_end").to_string(),
            Action::SelectDocumentStart => t!("action.select_document_start").to_string(),
            Action::SelectDocumentEnd => t!("action.select_document_end").to_string(),
            Action::SelectPageUp => t!("action.select_page_up").to_string(),
            Action::SelectPageDown => t!("action.select_page_down").to_string(),
            Action::SelectAll => t!("action.select_all").to_string(),
            Action::SelectWord => t!("action.select_word").to_string(),
            Action::SelectLine => t!("action.select_line").to_string(),
            Action::ExpandSelection => t!("action.expand_selection").to_string(),
            Action::BlockSelectLeft => t!("action.block_select_left").to_string(),
            Action::BlockSelectRight => t!("action.block_select_right").to_string(),
            Action::BlockSelectUp => t!("action.block_select_up").to_string(),
            Action::BlockSelectDown => t!("action.block_select_down").to_string(),
            Action::DeleteBackward => t!("action.delete_backward").to_string(),
            Action::DeleteForward => t!("action.delete_forward").to_string(),
            Action::DeleteWordBackward => t!("action.delete_word_backward").to_string(),
            Action::DeleteWordForward => t!("action.delete_word_forward").to_string(),
            Action::DeleteLine => t!("action.delete_line").to_string(),
            Action::DeleteToLineEnd => t!("action.delete_to_line_end").to_string(),
            Action::DeleteToLineStart => t!("action.delete_to_line_start").to_string(),
            Action::TransposeChars => t!("action.transpose_chars").to_string(),
            Action::OpenLine => t!("action.open_line").to_string(),
            Action::Recenter => t!("action.recenter").to_string(),
            Action::SetMark => t!("action.set_mark").to_string(),
            Action::Copy => t!("action.copy").to_string(),
            Action::CopyWithTheme(theme) if theme.is_empty() => {
                t!("action.copy_with_formatting").to_string()
            }
            Action::CopyWithTheme(theme) => t!("action.copy_with_theme", theme = theme).to_string(),
            Action::Cut => t!("action.cut").to_string(),
            Action::Paste => t!("action.paste").to_string(),
            Action::YankWordForward => t!("action.yank_word_forward").to_string(),
            Action::YankWordBackward => t!("action.yank_word_backward").to_string(),
            Action::YankToLineEnd => t!("action.yank_to_line_end").to_string(),
            Action::YankToLineStart => t!("action.yank_to_line_start").to_string(),
            Action::AddCursorAbove => t!("action.add_cursor_above").to_string(),
            Action::AddCursorBelow => t!("action.add_cursor_below").to_string(),
            Action::AddCursorNextMatch => t!("action.add_cursor_next_match").to_string(),
            Action::RemoveSecondaryCursors => t!("action.remove_secondary_cursors").to_string(),
            Action::Save => t!("action.save").to_string(),
            Action::SaveAs => t!("action.save_as").to_string(),
            Action::Open => t!("action.open").to_string(),
            Action::SwitchProject => t!("action.switch_project").to_string(),
            Action::New => t!("action.new").to_string(),
            Action::Close => t!("action.close").to_string(),
            Action::CloseTab => t!("action.close_tab").to_string(),
            Action::Quit => t!("action.quit").to_string(),
            Action::Revert => t!("action.revert").to_string(),
            Action::ToggleAutoRevert => t!("action.toggle_auto_revert").to_string(),
            Action::FormatBuffer => t!("action.format_buffer").to_string(),
            Action::GotoLine => t!("action.goto_line").to_string(),
            Action::GoToMatchingBracket => t!("action.goto_matching_bracket").to_string(),
            Action::JumpToNextError => t!("action.jump_to_next_error").to_string(),
            Action::JumpToPreviousError => t!("action.jump_to_previous_error").to_string(),
            Action::SmartHome => t!("action.smart_home").to_string(),
            Action::DedentSelection => t!("action.dedent_selection").to_string(),
            Action::ToggleComment => t!("action.toggle_comment").to_string(),
            Action::SetBookmark(c) => t!("action.set_bookmark", key = c).to_string(),
            Action::JumpToBookmark(c) => t!("action.jump_to_bookmark", key = c).to_string(),
            Action::ClearBookmark(c) => t!("action.clear_bookmark", key = c).to_string(),
            Action::ListBookmarks => t!("action.list_bookmarks").to_string(),
            Action::ToggleSearchCaseSensitive => {
                t!("action.toggle_search_case_sensitive").to_string()
            }
            Action::ToggleSearchWholeWord => t!("action.toggle_search_whole_word").to_string(),
            Action::ToggleSearchRegex => t!("action.toggle_search_regex").to_string(),
            Action::ToggleSearchConfirmEach => t!("action.toggle_search_confirm_each").to_string(),
            Action::StartMacroRecording => t!("action.start_macro_recording").to_string(),
            Action::StopMacroRecording => t!("action.stop_macro_recording").to_string(),
            Action::PlayMacro(c) => t!("action.play_macro", key = c).to_string(),
            Action::ToggleMacroRecording(c) => {
                t!("action.toggle_macro_recording", key = c).to_string()
            }
            Action::ShowMacro(c) => t!("action.show_macro", key = c).to_string(),
            Action::ListMacros => t!("action.list_macros").to_string(),
            Action::PromptRecordMacro => t!("action.prompt_record_macro").to_string(),
            Action::PromptPlayMacro => t!("action.prompt_play_macro").to_string(),
            Action::PlayLastMacro => t!("action.play_last_macro").to_string(),
            Action::PromptSetBookmark => t!("action.prompt_set_bookmark").to_string(),
            Action::PromptJumpToBookmark => t!("action.prompt_jump_to_bookmark").to_string(),
            Action::Undo => t!("action.undo").to_string(),
            Action::Redo => t!("action.redo").to_string(),
            Action::ScrollUp => t!("action.scroll_up").to_string(),
            Action::ScrollDown => t!("action.scroll_down").to_string(),
            Action::ShowHelp => t!("action.show_help").to_string(),
            Action::ShowKeyboardShortcuts => t!("action.show_keyboard_shortcuts").to_string(),
            Action::ShowWarnings => t!("action.show_warnings").to_string(),
            Action::ShowLspStatus => t!("action.show_lsp_status").to_string(),
            Action::ClearWarnings => t!("action.clear_warnings").to_string(),
            Action::CommandPalette => t!("action.command_palette").to_string(),
            Action::ToggleLineWrap => t!("action.toggle_line_wrap").to_string(),
            Action::ToggleComposeMode => t!("action.toggle_compose_mode").to_string(),
            Action::SetComposeWidth => t!("action.set_compose_width").to_string(),
            Action::NextBuffer => t!("action.next_buffer").to_string(),
            Action::PrevBuffer => t!("action.prev_buffer").to_string(),
            Action::NavigateBack => t!("action.navigate_back").to_string(),
            Action::NavigateForward => t!("action.navigate_forward").to_string(),
            Action::SplitHorizontal => t!("action.split_horizontal").to_string(),
            Action::SplitVertical => t!("action.split_vertical").to_string(),
            Action::CloseSplit => t!("action.close_split").to_string(),
            Action::NextSplit => t!("action.next_split").to_string(),
            Action::PrevSplit => t!("action.prev_split").to_string(),
            Action::IncreaseSplitSize => t!("action.increase_split_size").to_string(),
            Action::DecreaseSplitSize => t!("action.decrease_split_size").to_string(),
            Action::ToggleMaximizeSplit => t!("action.toggle_maximize_split").to_string(),
            Action::PromptConfirm => t!("action.prompt_confirm").to_string(),
            Action::PromptCancel => t!("action.prompt_cancel").to_string(),
            Action::PromptBackspace => t!("action.prompt_backspace").to_string(),
            Action::PromptDelete => t!("action.prompt_delete").to_string(),
            Action::PromptMoveLeft => t!("action.prompt_move_left").to_string(),
            Action::PromptMoveRight => t!("action.prompt_move_right").to_string(),
            Action::PromptMoveStart => t!("action.prompt_move_start").to_string(),
            Action::PromptMoveEnd => t!("action.prompt_move_end").to_string(),
            Action::PromptSelectPrev => t!("action.prompt_select_prev").to_string(),
            Action::PromptSelectNext => t!("action.prompt_select_next").to_string(),
            Action::PromptPageUp => t!("action.prompt_page_up").to_string(),
            Action::PromptPageDown => t!("action.prompt_page_down").to_string(),
            Action::PromptAcceptSuggestion => t!("action.prompt_accept_suggestion").to_string(),
            Action::PromptMoveWordLeft => t!("action.prompt_move_word_left").to_string(),
            Action::PromptMoveWordRight => t!("action.prompt_move_word_right").to_string(),
            Action::PromptDeleteWordForward => t!("action.prompt_delete_word_forward").to_string(),
            Action::PromptDeleteWordBackward => {
                t!("action.prompt_delete_word_backward").to_string()
            }
            Action::PromptDeleteToLineEnd => t!("action.prompt_delete_to_line_end").to_string(),
            Action::PromptCopy => t!("action.prompt_copy").to_string(),
            Action::PromptCut => t!("action.prompt_cut").to_string(),
            Action::PromptPaste => t!("action.prompt_paste").to_string(),
            Action::PromptMoveLeftSelecting => t!("action.prompt_move_left_selecting").to_string(),
            Action::PromptMoveRightSelecting => {
                t!("action.prompt_move_right_selecting").to_string()
            }
            Action::PromptMoveHomeSelecting => t!("action.prompt_move_home_selecting").to_string(),
            Action::PromptMoveEndSelecting => t!("action.prompt_move_end_selecting").to_string(),
            Action::PromptSelectWordLeft => t!("action.prompt_select_word_left").to_string(),
            Action::PromptSelectWordRight => t!("action.prompt_select_word_right").to_string(),
            Action::PromptSelectAll => t!("action.prompt_select_all").to_string(),
            Action::FileBrowserToggleHidden => t!("action.file_browser_toggle_hidden").to_string(),
            Action::PopupSelectNext => t!("action.popup_select_next").to_string(),
            Action::PopupSelectPrev => t!("action.popup_select_prev").to_string(),
            Action::PopupPageUp => t!("action.popup_page_up").to_string(),
            Action::PopupPageDown => t!("action.popup_page_down").to_string(),
            Action::PopupConfirm => t!("action.popup_confirm").to_string(),
            Action::PopupCancel => t!("action.popup_cancel").to_string(),
            Action::ToggleFileExplorer => t!("action.toggle_file_explorer").to_string(),
            Action::ToggleMenuBar => t!("action.toggle_menu_bar").to_string(),
            Action::FocusFileExplorer => t!("action.focus_file_explorer").to_string(),
            Action::FocusEditor => t!("action.focus_editor").to_string(),
            Action::FileExplorerUp => t!("action.file_explorer_up").to_string(),
            Action::FileExplorerDown => t!("action.file_explorer_down").to_string(),
            Action::FileExplorerPageUp => t!("action.file_explorer_page_up").to_string(),
            Action::FileExplorerPageDown => t!("action.file_explorer_page_down").to_string(),
            Action::FileExplorerExpand => t!("action.file_explorer_expand").to_string(),
            Action::FileExplorerCollapse => t!("action.file_explorer_collapse").to_string(),
            Action::FileExplorerOpen => t!("action.file_explorer_open").to_string(),
            Action::FileExplorerRefresh => t!("action.file_explorer_refresh").to_string(),
            Action::FileExplorerNewFile => t!("action.file_explorer_new_file").to_string(),
            Action::FileExplorerNewDirectory => {
                t!("action.file_explorer_new_directory").to_string()
            }
            Action::FileExplorerDelete => t!("action.file_explorer_delete").to_string(),
            Action::FileExplorerRename => t!("action.file_explorer_rename").to_string(),
            Action::FileExplorerToggleHidden => {
                t!("action.file_explorer_toggle_hidden").to_string()
            }
            Action::FileExplorerToggleGitignored => {
                t!("action.file_explorer_toggle_gitignored").to_string()
            }
            Action::LspCompletion => t!("action.lsp_completion").to_string(),
            Action::LspGotoDefinition => t!("action.lsp_goto_definition").to_string(),
            Action::LspReferences => t!("action.lsp_references").to_string(),
            Action::LspRename => t!("action.lsp_rename").to_string(),
            Action::LspHover => t!("action.lsp_hover").to_string(),
            Action::LspSignatureHelp => t!("action.lsp_signature_help").to_string(),
            Action::LspCodeActions => t!("action.lsp_code_actions").to_string(),
            Action::LspRestart => t!("action.lsp_restart").to_string(),
            Action::LspStop => t!("action.lsp_stop").to_string(),
            Action::ToggleInlayHints => t!("action.toggle_inlay_hints").to_string(),
            Action::ToggleMouseHover => t!("action.toggle_mouse_hover").to_string(),
            Action::ToggleLineNumbers => t!("action.toggle_line_numbers").to_string(),
            Action::ToggleMouseCapture => t!("action.toggle_mouse_capture").to_string(),
            Action::ToggleDebugHighlights => t!("action.toggle_debug_highlights").to_string(),
            Action::SetBackground => t!("action.set_background").to_string(),
            Action::SetBackgroundBlend => t!("action.set_background_blend").to_string(),
            Action::SetTabSize => t!("action.set_tab_size").to_string(),
            Action::SetLineEnding => t!("action.set_line_ending").to_string(),
            Action::ToggleIndentationStyle => t!("action.toggle_indentation_style").to_string(),
            Action::ToggleTabIndicators => t!("action.toggle_tab_indicators").to_string(),
            Action::ResetBufferSettings => t!("action.reset_buffer_settings").to_string(),
            Action::DumpConfig => t!("action.dump_config").to_string(),
            Action::Search => t!("action.search").to_string(),
            Action::FindInSelection => t!("action.find_in_selection").to_string(),
            Action::FindNext => t!("action.find_next").to_string(),
            Action::FindPrevious => t!("action.find_previous").to_string(),
            Action::FindSelectionNext => t!("action.find_selection_next").to_string(),
            Action::FindSelectionPrevious => t!("action.find_selection_previous").to_string(),
            Action::Replace => t!("action.replace").to_string(),
            Action::QueryReplace => t!("action.query_replace").to_string(),
            Action::MenuActivate => t!("action.menu_activate").to_string(),
            Action::MenuClose => t!("action.menu_close").to_string(),
            Action::MenuLeft => t!("action.menu_left").to_string(),
            Action::MenuRight => t!("action.menu_right").to_string(),
            Action::MenuUp => t!("action.menu_up").to_string(),
            Action::MenuDown => t!("action.menu_down").to_string(),
            Action::MenuExecute => t!("action.menu_execute").to_string(),
            Action::MenuOpen(name) => t!("action.menu_open", name = name).to_string(),
            Action::SwitchKeybindingMap(map) => {
                t!("action.switch_keybinding_map", map = map).to_string()
            }
            Action::PluginAction(name) => t!("action.plugin_action", name = name).to_string(),
            Action::ScrollTabsLeft => t!("action.scroll_tabs_left").to_string(),
            Action::ScrollTabsRight => t!("action.scroll_tabs_right").to_string(),
            Action::SelectTheme => t!("action.select_theme").to_string(),
            Action::SelectKeybindingMap => t!("action.select_keybinding_map").to_string(),
            Action::SelectCursorStyle => t!("action.select_cursor_style").to_string(),
            Action::SelectLocale => t!("action.select_locale").to_string(),
            Action::SwitchToPreviousTab => t!("action.switch_to_previous_tab").to_string(),
            Action::SwitchToTabByName => t!("action.switch_to_tab_by_name").to_string(),
            Action::OpenTerminal => t!("action.open_terminal").to_string(),
            Action::CloseTerminal => t!("action.close_terminal").to_string(),
            Action::FocusTerminal => t!("action.focus_terminal").to_string(),
            Action::TerminalEscape => t!("action.terminal_escape").to_string(),
            Action::ToggleKeyboardCapture => t!("action.toggle_keyboard_capture").to_string(),
            Action::TerminalPaste => t!("action.terminal_paste").to_string(),
            Action::OpenSettings => t!("action.open_settings").to_string(),
            Action::CloseSettings => t!("action.close_settings").to_string(),
            Action::SettingsSave => t!("action.settings_save").to_string(),
            Action::SettingsReset => t!("action.settings_reset").to_string(),
            Action::SettingsToggleFocus => t!("action.settings_toggle_focus").to_string(),
            Action::SettingsActivate => t!("action.settings_activate").to_string(),
            Action::SettingsSearch => t!("action.settings_search").to_string(),
            Action::SettingsHelp => t!("action.settings_help").to_string(),
            Action::SettingsIncrement => t!("action.settings_increment").to_string(),
            Action::SettingsDecrement => t!("action.settings_decrement").to_string(),
            Action::ShellCommand => t!("action.shell_command").to_string(),
