...
impl Editor {
    ...
    fn handle_tab_drag(&mut self, col: u16, row: u16) -> std::io::Result<()> {
    ...
    fn compute_tab_drop_zone(
        ...
        col: u16,
        row: u16,
        source_split_id: crate::model::event::SplitId,
    ...
    fn execute_tab_drop(
        ...
        drop_zone: super::types::TabDropZone,
    ) {
        use super::types::TabDropZone;
